			...
			<div class="main-panel">
				<div class="content-wrapper">
					...
					<div class="col-12 grid-margin stretch-card">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">메일 작성</h4>
								<p class="card-description">Basic form elements</p>
								<form class="forms-sample">
									<button type="submit" class="btn btn-primary mr-2">보내기</button>
									<button type="submit" class="btn btn-primary mr-2">임시저장</button>
									<button type="submit" class="btn btn-primary mr-2">예약 발송</button>
									<button class="btn btn-light">Cancel</button>
									<div class="form-group">
										<label for="exampleInputName1">받는 사람</label> <input
											type="text" class="form-control" id="exampleInputName1"
											placeholder="Name">
									</div>
									<div class="form-group">
										<label for="exampleInputEmail3">참조</label> <input type="email"
