								...
								<div class="card-body">
									<table align="center" cellpadding="10" cellspacing="0"
										...
										<tr align="center" valign="middle">
											<th colspan="2">${board.b_num}번글상세보기</th>
										</tr>
										<tr>
										...
										<c:forEach var="rep" items="${commentList}">
											<div id="comment">
												...
												<input type="hidden" id="rep_id" name="rep_id"
													value="${co.c_n}"> <input type="hidden"
													id="rep_pwd" name="rep_pwd" value="${rep.c_pwd}">
												<h4 class="comment-head">작성자 : ${rep.c_name}
													&nbsp; &nbsp;작성일 : ${rep.c_timestamp}</h4>
												...
												<p align="right">
													<button type="button" class="updateConfirm"
														name="updateConfirm" id="updateConfirm"
														style="display: none;">수정완료</button>
													&nbsp;&nbsp;&nbsp;
													<button type="button" class="delete" name="delete"
														id="delete" style="display: none;">삭제하기</button>
													&nbsp;&nbsp;&nbsp;
													<button type="button" class="update" name="update"
														id="update">수 정 및 삭제</button>
												</p>
											</div>
											<br>
											<br>
									...
									<div class="comment-box">
										<form action="brInsert.do" id="replyForm" method="get">
											<input type="hidden" id="board_num" name="board_num"
												value="${board.b_n}"> <input type="hidden"
												id="page" name="page" value="${currentPage}"> <input
												type="hidden" id="comments" name="comments" value="">
											<p align="center">
		...
		<div class="card">
			<div class="card-body">
				<div class="d-flex justify-content-between mb-3">
					...
					<div class="dropdown">
						<button class="btn btn-sm dropdown-toggle text-dark pt-0 pr-0"
