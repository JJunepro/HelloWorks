        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
             ...
             <form class="pt-3" method="POST" action="pwdSearch">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  <input type="mail" class="form-control form-control-lg" id="exampleInputEmail1" placeholder="이메일" name="mail">
                </div>
              ...
              <script>
                ...
                <div class="my-2 d-flex justify-content-between align-items-center">
                  ...
                  <a href="idSearch" class="auth-link text-black">아이디 찾기</a>
                </div>
            <!--     <div class="mb-2">
